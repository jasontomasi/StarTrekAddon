...
function EFFECT:Init(data)
	...
	self.mag = math.Clamp(self.entity:BoundingRadius()/1,200,99999) //Amount of Particles
	self.dur = 4 +CurTime()
...
function EFFECT:Think()
	...
	--self.entity:SetMaterial("models/props/cs_office/clouds")
	self.entity:SetRenderFX(6)
